...
#> 
   ...
   $dictionary = @{ "Petalm Africa Group Pty Ltd" = $tenantName;"Enter_the_Client_Secret_Here" = $pythonwebappAppKey;"Enter_the_Application_Id_here" = $pythonwebappAadApplication.AppId };
